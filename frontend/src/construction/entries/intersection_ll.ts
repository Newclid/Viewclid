...
export const intersectionLL: CatalogEntry = {
  ...
  slots: [
    { name: 'a', kind: 'pick', label: 'Pick the first point of line 1' },
    { name: 'b', kind: 'pick', label: 'Pick the second point of line 1' },
    { name: 'c', kind: 'pick', label: 'Pick the first point of line 2' },
    { name: 'd', kind: 'pick', label: 'Pick the second point of line 2' },
  ],
  edges: [],
  circles: [],
